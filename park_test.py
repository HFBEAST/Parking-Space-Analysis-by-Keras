...
if __name__ == '__main__':
    test_images = [plt.imread(path) for path in glob.glob('test_images/*.jpg')] # 停车场示意图
    weights_path = 'car1.h5' # 训练完成后的权重参数
    video_name = 'parking_video.mp4' # 目标视频
    class_dictionary = {} # 车位状态的定义
